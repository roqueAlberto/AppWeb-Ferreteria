                        ...
                        <div class="row">
                            <div class="col-lg-3 col-6 ml-5">
                                ...
                                <div class="small-box bg-info">
                                    ...
                                    <a href="informe.do?opcion=registros-ventas" class="small-box-footer"
                            ...
                            <div class="col-lg-3 col-6 ml-5">
                                ...
                                <div class="small-box bg-warning">
                                    ...
                                    <a href="gasto.do?opcion=consumos" class="small-box-footer"
                                       >Mas información<i class="fas fa-arrow-circle-right"></i
                                        ></a>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-6 ml-5">
                                ...
                                <div class="small-box bg-danger">
                                    ...
                                    <a href="anotacion.do?opcion=Inicio" class="small-box-footer"
                                       >Mas información <i class="fas fa-arrow-circle-right"></i
                                        ></a>
                                </div>
                            </div>
